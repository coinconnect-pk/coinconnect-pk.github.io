...
Most people who read the [Virtual Assets Act](https://blog.coinconnect.site/pakistans-virtual-assets-act-2026-the-complete-guide/) 2026 stop at the licensing chapter and assume that is the whole of [PVARA](https://www.coinconnect.site/pvara-guide)'s toolkit. It is not. Section 9 sets out what the Pakistan Virtual Assets Regulatory Authority (PVARA) is for, and then lists, power by power, what it is actually entitled to do to get there.
...
Section 9(2) of the Act gives PVARA fourteen specific powers "for the purposes of sub-section (1), and without prejudice to the generality of the foregoing." They range from making binding rules to running a [regulatory sandbox](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-sandbox-form-i-complete-walkthrough-2026-8) to simply running public education campaigns. Together they cover rule-making, licensing, supervision, enforcement, cooperation and outreach.
...
Read together with Chapter 3 of the Act — the [licensing framework](https://www.coinconnect.site/pvara-guide) proper — these two powers are what allow PVARA to move the goalposts on eligibility and renewal without new legislation. An applicant going through the [no objection certificate](https://www.coinconnect.site/regulatory-licensing) process or a licensee approaching renewal should treat these conditions as capable of change between application cycles.
...
These three powers underpin the [ongoing compliance](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-phase-2-compliance-failure-11) obligations a licensee carries after the licence is granted — this is not a one-time gate. Refusal to provide information demanded under 9(2)(f) also has criminal consequences: section 57(3) of the Act punishes wilful refusal to provide information to an authorised officer with imprisonment up to one year or a fine up to one million Rupees.
...
The committee power in 9(2)(n) is open-ended by design — it does not name any specific committee (the Act separately names a [Shariah Advisory Committee](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-frt-stablecoin-issuance-32) under section 3(1)(xxvii) and permits a regulatory coordination committee under section 17(3)), leaving PVARA free to stand up whatever internal or cross-agency working group a given issue requires.
...
Anyone building a [corporate structure](https://www.coinconnect.site/corporate-setup) for a Pakistan VASP should read section 9(2) alongside the licensing chapter, not instead of it — the powers listed here determine how much the rules can move under your feet between the day you apply and the day you are fully licensed. If a specific instrument — a Regulation, a directive, a circular — has not yet been published under 9(2)(a) or (b), the underlying power still exists; only the detail is missing.
