...
Not every licensing decision under the [Virtual Assets Act](https://blog.coinconnect.site/pakistans-virtual-assets-act-2026-the-complete-guide/) 2026 is a straight grant-or-refuse choice. Section 21 gives the Pakistan Virtual Assets Regulatory Authority ([PVARA](https://www.coinconnect.site/pvara-guide)) a third option — a provisional or limited-scope licence — alongside the standard grant and refusal outcomes for a full [licence application](https://www.coinconnect.site/regulatory-licensing). This is a narrower, more discretionary tool than it might sound, and the Act leaves much of how it works to be filled in later.
...
- **Limited-scope licence** — the natural reading is a licence restricted to a subset of [virtual asset](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-license-pakistan-complete-guide-22) services, or to a reduced scale of activity, though again the Act does not itself specify how that scope is defined or measured.
...
It is easy to conflate a limited-scope licence with the [regulatory sandbox](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-sandbox-form-i-complete-walkthrough-2026-8), but the Act treats them as separate mechanisms in separate chapters.
