...
Regulation 2.3 designates four categories of [virtual asset service](https://blog.coinconnect.site/pakistans-virtual-assets-act-2026-the-complete-guide/) as non-financial businesses and professions under Section 38(1) of the Ordinance, for the purposes of AML Registration on the goAML portal following receipt of an NOC:
...
| Service | Coverage |
|---|---|
| [Broker-Dealer](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-broker-dealer-license-what-it-covers-27) Services | Dealing in virtual assets on behalf of, or as principal against, customers |
| [Custody](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-custody-license-safeguarding-customer-assets-25) Services | Holding or safeguarding [customer assets](https://www.coinconnect.site/blog/3/customer-assets-definition-pvara-pakistan-62) on a customer's behalf |
| [Exchange Services](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-exchange-license-requirements-capital-obligations-24) | Facilitating the trading or conversion of virtual assets |
| [Derivatives](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-derivatives-leverage-license-31) Services | Virtual asset derivative products |
...
Regulation 9.3 adds a separate, service-level condition that applies before any individual customer relationship: customer due diligence "must be completed before the Applicant provides any AML Registered Service." A general AML Registration at entity level does not substitute for [fit and proper](https://www.coinconnect.site/blog/coinconnect-insights-1/url-slug-fit-and-proper-test-pvara-form-a3-14)-standard customer checks at the transaction level.
...
1. PVARA issues the NOC, which under Regulation 2.2 approves AML Registration and permits [incorporation](https://www.coinconnect.site/corporate-setup).
2. The Applicant completes [goAML](https://www.coinconnect.site/blog/coinconnect-insights-1/fmu-goaml-vasp-pakistan-17) registration as the reporting entity.
3. Only once goAML registration is complete may the Applicant begin providing the four AML-Registered Services, subject to whatever conditions PVARA has imposed.
...
No. Regulation 2.3 is explicit that it does not: "For the avoidance of doubt, all other Virtual Asset Services defined under the Ordinance not otherwise constituted as an AML Registered Service may only be provided following the grant of a full license under Section 17, unless otherwise agreed with PVARA." Any [Schedule I](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-license-categories-explained-23) service category outside the four listed here — for example lending, [transfer and settlement](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-transfer-settlement-license-payments-remittance-28), or [investment services](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-management-investment-services-license-29) — stays locked behind full licensing under this Regulation, with the narrow exception of "unless otherwise agreed with PVARA," which the Regulations do not further define.
