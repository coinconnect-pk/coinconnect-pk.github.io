...
This matters commercially before it matters doctrinally. Any exchange, issuer or advisory business planning to market a product as "Shariah compliant" in Pakistan needs to know precisely what the [Virtual Assets Act](https://blog.coinconnect.site/pakistans-virtual-assets-act-2026-the-complete-guide/) actually requires on this point, and what it merely gestures toward. The honest answer is that the operative detail has not yet been written.
...
The one concrete, operative reference we found across the three source documents reviewed for this piece sits in PVARA's Sandbox Guidelines 2026, not in the Act itself. Under the Key Evaluation Criteria for [sandbox](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-sandbox-reduced-capital-pakistan-19) applications, the Risk Management and Compliance heading lists:
...
- **Reserve-backing rules already push some products toward structures that read as more conservative, without the Act framing this as Shariah compliance.** [Fiat-referenced tokens](https://blog.coinconnect.site/coinconnect-insights-1/pvara-frt-stablecoin-issuance-32) must maintain 100% reserve backing in high-quality liquid assets under section 31, and [asset-referenced tokens](https://blog.coinconnect.site/coinconnect-insights-1/pvara-art-tokenized-gold-issuance-33) must be fully backed by underlying assets under section 32. Full backing without leverage is a feature many Islamic-finance practitioners would recognise as consistent with prohibitions on speculative, unbacked instruments. Our reading is that this is a structural side-effect of the prudential rules, not evidence that the Act has built a Shariah-screening mechanism — that distinction matters and should not be blurred in marketing copy.
...
1. Do not describe PVARA licensing or NOC approval as Shariah certification — the Act does not equate the two.
2. If Shariah compliance is part of the value proposition, commission an independent Shariah board opinion rather than relying on future PVARA machinery that has not yet been constituted.
3. Track PVARA's Regulations under section 68 for the point at which the Shariah Advisory Committee's mandate, if any, is formally defined.
4. In [sandbox](https://blog.coinconnect.site/coinconnect-insights-1/pvara-sandbox-form-i-complete-walkthrough-2026-8) applications specifically, be ready to show evidence of Shariah-advisor consultation if the product's risk profile makes it "applicable" under the Guidelines' evaluation criteria.
5. Keep the [fit-and-proper](https://blog.coinconnect.site/coinconnect-insights-1/url-slug-fit-and-proper-test-pvara-form-a3-14) and AML documentation for [Key Individuals](https://blog.coinconnect.site/coinconnect-insights-1/pvara-license-categories-explained-23) current regardless — that assessment runs on its own track and is unaffected by whether a Shariah opinion has been obtained.

## Why does the gap exist, and should it worry a market entrant?

Framework legislation of this kind routinely names a concept before the machinery around it is built — the same pattern shows up elsewhere in the Act, where terms such as [High-Quality Liquid Assets](https://www.coinconnect.site/pvara-guide) are defined but their content is left "as may be prescribed by Regulations." Read that way, the Shariah Advisory Committee looks less like an oversight and more like a placeholder the legislature expected the Authority to fill in later, alongside the broader body of Regulations still to come under [PVARA's licensing framework](https://www.coinconnect.site/regulatory-licensing).

It should not stop a market entrant from proceeding with [SECP incorporation](https://www.coinconnect.site/corporate-setup) or an [NOC application](https://blog.coinconnect.site/coinconnect-insights-1/pvara-license-pakistan-complete-guide-22). It should stop that entrant from telling customers, investors or [banking partners](https://www.coinconnect.site/tax-banking) that PVARA registration carries a religious-compliance guarantee it has not, on the text available today, actually made.
