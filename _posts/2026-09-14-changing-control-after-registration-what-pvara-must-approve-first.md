...
Buying into a licensed [Virtual Asset Service Provider](https://www.coinconnect.site/blog/coinconnect-insights-1/vasp-license-pakistan-3) in Pakistan is not a transaction you can complete quietly and disclose afterwards. Once an entity is registered with [PVARA](https://www.coinconnect.site/pvara-guide), any move to acquire or increase control over it has to clear the regulator's desk first, not after the fact.

This piece works through the prior-approval requirement in Regulation 7.3 of the [PVARA No Objection Certificate](https://www.coinconnect.site/regulatory-licensing) Regulations 2025 and Section 22(d) of the [Virtual Assets Act](https://blog.coinconnect.site/pakistans-virtual-assets-act-2026-the-complete-guide/) 2026, and sets out what is settled in the source documents and what is still left to PVARA to define.
...
The first sentence covers the entry point: no [Controller](https://www.coinconnect.site/blog/3/pakistan-pvara-controller-virtual-assets-act-2026-58) is admitted to the ownership structure of an Applicant without PVARA's approval at the [AML](https://www.coinconnect.site/blog/3/fit-and-proper-aml-pvara-mistakes-54)-registration stage. The second sentence is the ongoing rule this article is about — once the entity is registered, any [Controller](https://www.coinconnect.site/blog/3/pakistan-pvara-controller-virtual-assets-act-2026-58) looking to increase its stake above a threshold PVARA sets needs the same approval, applied for and granted, before the increase happens.
...
Section 22 of the Act sets out the ongoing obligations every [Licensee](https://www.coinconnect.site/pvara-guide) carries "at all times," and paragraph (d) covers control changes directly:
...
A change of control is not just a paperwork exercise — the incoming or expanding Controller has to independently satisfy PVARA's [fit and proper](https://www.coinconnect.site/blog/coinconnect-insights-1/url-slug-fit-and-proper-test-pvara-form-a3-14) standard. Section 20(1) of the Act gives PVARA direct authority to determine whether a Controller is fit and proper, and Section 20(5) requires PVARA to prescribe additional requirements for corporate Controllers specifically, including assessment of "the corporate behaviour, integrity and track record of Controller and ultimate beneficial owners." A control-change approval under Regulation 7.3, in other words, is not a separate, lighter process from the [fit and proper](https://www.coinconnect.site/blog/coinconnect-insights-1/url-slug-fit-and-proper-test-pvara-form-a3-14) assessment applied to Controllers generally — it triggers the same scrutiny a new Controller would face at [NOC](https://www.coinconnect.site/regulatory-licensing) stage.
