...
Most operators reading the [Virtual Assets Act](https://blog.coinconnect.site/pakistans-virtual-assets-act-2026-the-complete-guide/), 2026 for the first time treat [PVARA](https://www.coinconnect.site/pvara-guide) as the beginning and the end of the regulatory relationship. It is not. Sitting above the Authority is a body the Act calls the "Division concerned", and it appears at three points that matter commercially.

Understanding who sits above your regulator tells you where a rule actually comes from, who can change it, and [how long](https://www.coinconnect.site/blog/3/how-long-pvara-license-takes-39) that change is likely to take. It also tells you which decisions your regulator can make alone and which require sign-off elsewhere.

## What is the "Division concerned" under the Act?

Section 3(1)(viii) defines it in one line: the Division concerned "means the Cabinet Division as defined in the Rules of Business, 1973". The Cabinet Division is the federal executive department that services the Cabinet and the Prime Minister's Office. It is not a financial regulator, and it is not a specialist [virtual asset](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-license-pakistan-complete-guide-22) body.
...
Our reading is that this will be addressed through Regulations or administrative notification rather than in the Act itself. Until it is, the practical step is to ask the Authority directly which firms currently satisfy section 27(2) before you commit to an auditor as part of your [corporate setup](https://www.coinconnect.site/corporate-setup). Verify the current position with [PVARA](https://www.coinconnect.site/pvara-guide) rather than assuming your existing auditor qualifies.
...
1. **Detail arrives more slowly than it would from a standalone regulator.** If your business model depends on a threshold that has not yet been prescribed, plan for the wait rather than assuming imminent publication.
2. **Once made, the detail carries more weight.** A Regulation that has been through Cabinet Division consultation is less likely to be reversed casually.

Where you are choosing between the [licensing routes](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-routes-compared-sandbox-noc-license-20) available under the Act, the pace of regulation-making is a real input into that decision.
...
That is an accountability mechanism for the Authority's own governance and finances. It is not a mechanism by which the Cabinet Division supervises individual licensees. Nothing in section 15(7) gives the Division a role in your [licence application](https://www.coinconnect.site/regulatory-licensing), your supervision, or any enforcement action against you.
...
- **Confirm your auditor before you need one.** Section 27(2) approval is not something to discover during your first audit cycle. Raise it early, alongside your other [SECP](https://www.coinconnect.site/corporate-setup) and banking arrangements.
...
- **Direct regulatory questions to the Authority.** The Cabinet Division's role is upstream. Questions about your own licence, your [customer assets](https://www.coinconnect.site/blog/3/customer-assets-definition-pvara-pakistan-62) obligations, or your [ongoing compliance](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-phase-2-compliance-failure-11) belong with PVARA.
...
None of this is a compliance obligation on you. But a regulator that publishes annually against stated objectives is one whose direction can be read, and reading it is cheaper than guessing. Operators tracking their [ongoing compliance](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-phase-2-compliance-failure-11) burden should treat the report as a standing diary entry.
