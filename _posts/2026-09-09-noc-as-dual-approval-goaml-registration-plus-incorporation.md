...
A [No Objection Certificate](https://www.coinconnect.site/regulatory-licensing) ("NOC") sounds like a single, narrow clearance. Under the [PVARA](https://www.coinconnect.site/pvara-guide) No Objection Certificate Regulations 2025 it is not. Regulation 2.2 defines an NOC as granting two separate permissions at once, and treating them as one undifferentiated approval is a common source of confusion for an Applicant planning its Pakistan entry sequence.

This article isolates each permission, explains how they interact, and sets out what an Applicant is expected to do with each one [once the NOC](https://www.coinconnect.site/blog/coinconnect-insights-1/post-noc-pakistan-operational-playbook-12) is issued.

## What two things does a PVARA NOC approve at the same time?

Regulation 2.2 states that PVARA's issuance of an NOC "required under Section 15 of the Ordinance shall constitute (i) approval for the Applicant's [AML](https://www.coinconnect.site/blog/3/fit-and-proper-aml-pvara-mistakes-54) Registration on the goAML portal; and (ii) permission for the Applicant to proceed with [incorporation](https://www.coinconnect.site/corporate-setup) of its local entity in Pakistan." One decision, two distinct and independently actionable outcomes.

- **AML Registration approval** — clearance to register on the Financial Monitoring Unit's [goAML](https://www.coinconnect.site/blog/coinconnect-insights-1/fmu-goaml-vasp-pakistan-17) reporting platform as a designated non-financial business.
...
Because the Regulations deliberately separate AML compliance from full licensing as two different regulatory gates. Regulation 2.3 explains why: four categories of virtual asset service — broker-dealer, [custody](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-custody-license-safeguarding-customer-assets-25), [exchange](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-exchange-license-requirements-capital-obligations-24) and [derivatives](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-derivatives-leverage-license-31) services — are "designated non-financial businesses and professions in accordance with Section 38(1) of the Ordinance" once an Applicant holds AML Registration. That designation is what lets an Applicant provide those four services, under conditions PVARA sets, before a full licence under Section 17 has been granted at all.
...
In practice, this is what separates PVARA's regime from a conventional [SECP](https://www.coinconnect.site/corporate-setup) company registration, where incorporation ordinarily comes first and sector approval follows. Here, a VASP applicant cannot lawfully incorporate its local entity for this purpose ahead of the NOC — the NOC is the gate that opens the door to incorporation, not a step that gets layered on top of an entity that already exists.
...
1. Register the foreign entity already providing AML-Registered Services in Pakistan on the goAML portal.
2. Incorporate a local company, as required under Section 15(1) of the Ordinance.
3. Submit the licensing application, in the form PVARA prescribes, within three months of the issuance of the VASP licensing regulations.

The third action is not part of the dual approval in Regulation 2.2 itself, but it is the deadline that anchors the entire phased pathway — the [licensing routes](https://www.coinconnect.site/blog/3/pvara-routes-compared-sandbox-noc-license-20) available under the NOC are time-limited, not indefinite. Regulation 17.1(a)(iv) repeats the same three-month clock as part of PVARA's decision letter itself, and Regulation 19.1(e) makes "failure to apply for or progress toward obtaining a full VASP License within the prescribed period" a ground for revoking the NOC entirely.
...
It exposes the Applicant to the exact enforcement risk Regulation 19 describes. An Applicant that incorporates its local entity but never completes AML Registration, or that registers on goAML but never files suspicious activity reports through it, has only executed half of what Regulation 2.2 actually authorised. Regulation 19.1(b) allows PVARA to revoke the NOC — [including AML Registration status](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-phase-2-compliance-failure-11) — for a breach of AML/CFT obligations, and the ongoing obligations in Regulation 18.1 require maintaining "active FMU goAML registration" at all times, not merely obtaining it once and setting it aside.
