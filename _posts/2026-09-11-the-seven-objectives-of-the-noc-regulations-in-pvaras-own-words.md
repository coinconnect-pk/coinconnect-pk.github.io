...
Every substantive obligation in the [PVARA](https://www.coinconnect.site/pvara-guide) [No Objection Certificate](https://www.coinconnect.site/regulatory-licensing) Regulations 2025 — governance, [fit and proper](https://www.coinconnect.site/blog/coinconnect-insights-1/url-slug-fit-and-proper-test-pvara-form-a3-14) standards, the [AML](https://www.coinconnect.site/blog/3/fit-and-proper-aml-pvara-mistakes-54)/CFT framework, ongoing reporting — exists to serve one of seven stated purposes. Regulation 3.1 lists them directly, and reading them together explains why the Regulations are built the way they are, rather than treating each later requirement as an isolated rule.
...
| (e) FMU integration | Connection to [goAML](https://www.coinconnect.site/blog/coinconnect-insights-1/fmu-goaml-vasp-pakistan-17) once the NOC issues |
...
Objective (a) is implemented in Part 4 of the Regulations. Regulation 8.2 lists the minimum components of the framework every Applicant must maintain: a Board-approved [AML](https://www.coinconnect.site/blog/3/fit-and-proper-aml-pvara-mistakes-54)/CFT policy, documented customer due diligence and enhanced due diligence procedures, targeted financial sanctions screening, transaction monitoring processes, suspicious and currency transaction report escalation procedures, a documented enterprise-wide risk assessment, a recordkeeping and data governance policy, a training programme, and an outsourcing risk management framework. That list is the practical shape of what "minimum standards" means under this instrument — it is not left as an abstract phrase.

## How is fitness and propriety of Controllers and Key Individuals actually assessed?

Objective (b) is implemented through Parts 2 and 3 of the Regulations. Regulation 6.1 requires all Key Individuals to satisfy [fit and proper](https://www.coinconnect.site/blog/coinconnect-insights-1/url-slug-fit-and-proper-test-pvara-form-a3-14) standards of integrity, competence, financial soundness and experience "as prescribed by section 16 of the Act." Regulation 6.3 sets hard exclusions — conviction for an AML-related or dishonesty offence, sanction by a regulator, or undischarged bankruptcy or insolvency — that automatically disqualify a candidate. Regulation 7.1 applies a parallel standard to any [Controller](https://www.coinconnect.site/blog/3/pakistan-pvara-controller-virtual-assets-act-2026-58) holding 20% or more of voting power or share capital, requiring PVARA's approval before AML registration may be granted.
