...
This composition is worth reading carefully. It places the heads of the [State Bank of Pakistan](https://www.sbp.org.pk) and the [Securities and Exchange Commission of Pakistan](https://www.secp.gov.pk) inside the regulator itself. In practice, that structure builds inter-regulator coordination into PVARA's own decision-making rather than leaving it to correspondence between institutions.
