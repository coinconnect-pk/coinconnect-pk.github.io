...
The provision does not set out the standards itself. Instead it establishes that whoever physically holds reserve assets — for a [fiat-referenced token](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-frt-stablecoin-issuance-32) or an [asset-referenced token](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-art-tokenized-gold-issuance-33) — falls within the Authority's supervisory reach, even where that custodian is a separate legal person from the Issuer itself.
...
- coordinating custody arrangements with the [proof-of-reserves](https://www.coinconnect.site/blog/3/customer-assets-definition-pvara-pakistan-62) and audit obligations under section 27, which require the Licensee to reconcile reserves against liabilities even where a third party physically holds the assets
...
Three things are not yet settled by the Act itself and depend entirely on Regulations that had not been published at the time of writing: the specific requirements a reserve custodian must meet to obtain Authority approval, the detailed content of the "oversight and inspection standards" referred to in section 28, and whether self-custody of reserve assets by the Issuer is permitted in any circumstances. Firms building a [Fiat-Referenced Token](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-frt-stablecoin-issuance-32) or [Asset-Referenced Token](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-art-tokenized-gold-issuance-33) programme should treat the custodian relationship as a core piece of the [licence application](https://www.coinconnect.site/regulatory-licensing), not a detail to finalise after the licence is granted, given that section 30(1) restricts an Initial Virtual Asset Offering to entities that meet the eligibility criteria the Authority prescribes, and reserve custody arrangements are a natural part of that assessment.
