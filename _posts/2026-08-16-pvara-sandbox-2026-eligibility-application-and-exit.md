...
Pakistan's [virtual asset](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-license-pakistan-complete-guide-22) framework gives the regulator two very different doors. One is the full licensing route — incorporate, capitalise, get authorised, operate. The other is the [sandbox](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-sandbox-reduced-capital-pakistan-19): a controlled environment in which a firm tests a genuinely new product on a limited basis, under supervision, before it is licensed at all.

The Pakistan Virtual Asset Regulatory Authority ([PVARA](https://www.coinconnect.site/pvara-guide)) has published Sandbox Guidelines 2026 setting out how that second door works — eligibility, the application form, the assessment clock, the reporting burden during testing, and what happens on exit.
...
## Where does the sandbox get its legal authority?
...
Form E carries a structural requirement for offshore applicants: "In case if the applicant is not a local company, it will be required to have the company incorporated and evidence tax registration with local tax authorities as and when sandbox approval is granted." Sandbox approval therefore triggers the same [company registration](https://www.coinconnect.site/corporate-setup) and [tax registration](https://www.coinconnect.site/tax-banking) workstreams a licensing applicant faces. Our section-by-section [Form I walkthrough](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-sandbox-form-i-complete-walkthrough-2026-8) covers the drafting in detail.
...
Successful applicants receive a **Letter of Approval (LoA)** subject to terms and conditions approved by the Authority, and must then submit the Annexure-B undertaking. If you are still weighing entry routes, our comparison of [sandbox, NOC, no-action and full licence](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-routes-compared-sandbox-noc-license-20) sets the options against each other, and the [regulatory and licensing service page](https://www.coinconnect.site/regulatory-licensing) explains how we run these applications.
...
Separately, PVARA may temporarily suspend testing and approval until a matter is clarified, or "completely withdraw the approval with a public notice in case a serious discrepancy has been observed related to consumer detriment or any other serious matter". A public withdrawal notice is a reputational event, not merely a regulatory one — a theme we develop in our piece on [protecting reputation on market entry](https://www.coinconnect.site/blog/3/protecting-reputation-pakistan-crypto-entry-55).
