...
The route in is sequenced. Under section 19(1), any person intending to incorporate a company with the primary objective of engaging in Virtual Asset Services must **first** apply for a No-Objection Certificate before commencing incorporation. Section 19(4) then provides for the licence application following incorporation. The [PVARA NOC and SECP registration pathway](https://www.coinconnect.site/regulatory-licensing) runs in that order, and the [corporate setup work](https://www.coinconnect.site/corporate-setup) cannot lawfully start before the NOC is in hand.

Which services require a licence is set out in Schedule I, read with section 18. We have broken these down in [the 10 PVARA licence categories explained](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-license-categories-explained-23), and there is a fuller treatment in the [PVARA licence guide](https://www.coinconnect.site/pvara-guide).
...
Two practical observations. First, the Regulations plainly assume some foreign platforms are already serving Pakistani users — the drafting is an accommodation, not a prohibition. Second, they create real disclosure obligations for the offshore entity: Form A1 requires Key Individual details "for both the global entity being registered on the goAML portal and the proposed local entity in Pakistan", and Form A2 requires beneficial ownership disclosure for both. The [FMU goAML registration process](https://www.coinconnect.site/blog/coinconnect-insights-1/fmu-goaml-vasp-pakistan-17) and the [post-NOC operational sequence](https://www.coinconnect.site/blog/coinconnect-insights-1/post-noc-pakistan-operational-playbook-12) are worth reading together on this point.
...
For firms that want to test the market before committing to a full licence, the [sandbox route](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-sandbox-reduced-capital-pakistan-19) exists under section 35, and we compare the available paths in [sandbox vs NOC vs no-action letter vs full licence](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-routes-compared-sandbox-noc-license-20). Note that Sandbox Guidelines require a non-local applicant to incorporate locally and evidence tax registration once sandbox approval is granted.
...
- **Prepare the banking side early.** A licence does not produce a bank account; see [crypto banking in Pakistan](https://www.coinconnect.site/blog/coinconnect-insights-1/crypto-banking-pakistan-vasp-15) and our [tax and banking work](https://www.coinconnect.site/tax-banking).
