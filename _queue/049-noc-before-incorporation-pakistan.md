...
Anyone planning a [virtual asset](https://www.coinconnect.site/blog/coinconnect-insights-1/pvara-license-pakistan-complete-guide-22) business in Pakistan usually assumes the order runs incorporate, then license. Section 19 of the [Virtual Assets Act](https://blog.coinconnect.site/pakistans-virtual-assets-act-2026-the-complete-guide/) 2026 reverses that order for a specific category of company. Where the primary objective of the business is to provide virtual asset services, [incorporation](https://www.coinconnect.site/corporate-setup) is not step one. It cannot lawfully begin until the Pakistan Virtual Assets Regulatory Authority ([PVARA](https://www.coinconnect.site/pvara-guide)) has issued a No-Objection Certificate.
...
Two features of that wording matter. First, the trigger is intent, not the act of incorporation — a person who has decided to build a [virtual asset service provider](https://www.coinconnect.site/blog/coinconnect-insights-1/vasp-license-pakistan-3) is already inside the rule before any document reaches the Securities and Exchange Commission of Pakistan (SECP). Second, the word "first" and the phrase "before commencing the process of such incorporation" rule out running incorporation and the NOC application in parallel. One must precede the other.
...
- Directors and Key Individuals, each supported by a [fit and proper](https://www.coinconnect.site/blog/coinconnect-insights-1/url-slug-fit-and-proper-test-pvara-form-a3-14) questionnaire
- Controllers and beneficial owners, with ownership and control charts
- The applicant's [anti-money laundering](https://www.coinconnect.site/blog/3/fit-and-proper-aml-pvara-mistakes-54) and countering the financing of terrorism framework
